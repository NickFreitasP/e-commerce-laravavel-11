                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pname">
                                                        <div class="image">
                                                            <img src="{{asset("uploads/categories/".$categorie->image)}}" alt="" class="image">
                                                        </div>
                                                        <div class="name">
                                                    ...
                                                    <td>
                                                        <div class="list-icon-function">
                                                            <a href="{{route("admin.edit-category",['id'=>$categorie->id])}}">
                                                                <div class="item edit">
                                                                    <i class="icon-edit-3"></i>
                                                                </div>
                                                            </a>
                                                            <form action="{{route("admin.delete-category",['id'=>$categorie->id])}}" method="POST">
                                                                @csrf
                                                                @method("DELETE")
