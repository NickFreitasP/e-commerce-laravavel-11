      ...
      <div class="row">
            ...
            <div class="product-single__image">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    @foreach ( $product->imagesGallery as $images )

                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{asset("uploads/products/".$images->image)}}" width="674"
                        height="674" alt="" />
                ...
                <div class="swiper-wrapper">
                  @foreach ( $product->imagesGallery as $images )
                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumbnails/'.$images->image)}}" width="104" height="104" alt="" />
                    </div>
                  @endforeach
                </div>
              </div>
        ...
        <div class="col-lg-5">
          ...
          @if(Cart::instance("cart")->content()->where("id",$product->id)->count() > 0 )
            <a class="btn btn-warning mb-5" href="{{route("cart")}}">Go to cart</a>
          @else
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route("shop_details",["slug"=>$releted_product->slug])}}">

                    <img loading="lazy" src="{{asset("uploads/products/".$releted_product->image)}}" width="330" height="400"
                    alt="{{$releted_product->name}}" class="pc__img">

                    @foreach ($releted_product->imagesGallery as $images )
                        <img loading="lazy" src="{{asset("uploads/products/".$images->image)}}" width="330" height="400"
                        alt="{{$releted_product->name}}" class="pc__img pc__img-second">
                    @endforeach
                </a>



                <form method="post" action="{{route("add-item-cart")}}">
                           @csrf
                            <button
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">{{$releted_product->category->name}}</p>
                <h6 class="pc__title"><a href="{{route("shop_details",["slug",$releted_product->slug])}}">{{$releted_product->name}}</a></h6>
               <div class="product-card__price d-flex">

                    @if($releted_product->sale_price)
                     <span class="money price price-old">${{$releted_product->regular_price}}</span>
                     <span class="money price price-sale">${{$releted_product->sale_price}}</span>
                     @else
                   <span class="money price"> ${{$releted_product->regular_price}}</span>
