                ...
                <ul class="list list-inline mb-0">
                  @foreach ($categories as $category )
                    ...
                    <span class="menu-link py-1">
                        <input type="checkbox" name="f_category" id="f_category" value="{{$category->id}}"
                         @if(in_array($category->id,explode(",",$f_category))) checked="checked" @endif>
                        {{$category->name}}
                    </span>
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                   <ul class="list list-inline mb-0 brand-list">
                      @foreach ( $brands as $brand )
                        <li class="list-item">
                           <span class="menu-link py-1">
                              <input type="checkbox" name="brands_chk" value="{{$brand->id}}" class="chk-brand"
        ...
        <div class="accordion" id="price-filters">
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" id="price_range" value="" data-slider-min="10"
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 mr-3"  aria-label="Page size"
              name="pagesize" id="pagesize">
              <option class="mx-2" value="12"   {{$size==12 ? "selected" : ""}}> Show</option>
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              ...
              <option value="1" {{$order == 1 ? "selected" : ""}}>Mais Novos</option>
              <option value="2" {{$order == 2 ? "selected" : ""}}>Mais Antigos</option>
        ...
        <div class="products-grid row row-cols-2 row-cols-md-3" id="products-grid">
                ...
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    @foreach ($product->imagesGallery as $image)
                        <div class="swiper-slide">
                          <a href="{{route("shop_details",["slug"=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products/'.$image->image)}}" width="330"
          ...
          @if(Cart::instance("cart")->content()->where("id",$product->id)->count() > 0 )
            <a class="btn btn-warning mb-5 pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" href="{{route("cart")}}">Go to cart</a>
          @else
          <form class="" action="{{route("add-item-cart")}}" method="POST">
                 @csrf
                 @method("POST")
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btn btn-white mb-5 pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer">Add to
                Cart</button>
            </div>
          </form>
         @endif
...
<form id="formfilter" action="{{route("shop")}}" method="GET">
...
<script>
  $(function(){
    ...
    $("input[name='brands_chk']").on("change",function(){

        var brands = "";
        $("input[name='brands_chk']:checked").each(function(){
            if(brands == "")
            {
                  brands += $(this).val();
            }
    ...
    $("input[name='f_category']").on("change",function(){
        ...
        $("input[name='f_category']:checked").each(function(){
            if(category == "")
            {
                  category += $(this).val();
            }
